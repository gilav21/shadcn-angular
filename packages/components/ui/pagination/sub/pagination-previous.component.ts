...
export class PaginationPreviousComponent {
  /** Extra classes merged onto the "previous" button. Its chevron is flipped automatically in RTL. */
  readonly class = input('');
  /** Disables the button — set it on page 1. Nothing computes this for you in template mode, and the component emits no event of its own; bind your own click handler. */
