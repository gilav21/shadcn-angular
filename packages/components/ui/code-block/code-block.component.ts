...
export class CodeBlockComponent {
    ...
    private readonly LANGUAGE_PATTERNS: Readonly<Record<string, LanguagePattern>> = {
        typescript: [
            { type: 'comment', regex: /\/\/.*/ },
            { type: 'string', regex: /(["'])(?:(?=(\\?))\2.)*?\1/ },            { type: 'keyword', regex: /\b(const|let|var|function|class|import|from|return|if|else|for|while|export|interface|type|public|private|protected|implements|extends|new|this|true|false|null|undefined|void|async|await)\b/ },
            { type: 'number', regex: /\b\d+\b/ },
            { type: 'function', regex: /\b[a-zA-Z_$]\w*(?=\()/ },
        ],
        javascript: [
            { type: 'comment', regex: /\/\/.*/ },
            { type: 'string', regex: /(["'])(?:(?=(\\?))\2.)*?\1/ },            { type: 'keyword', regex: /\b(const|let|var|function|class|import|from|return|if|else|for|while|export|new|this|true|false|null|undefined|void|async|await)\b/ },
            { type: 'number', regex: /\b\d+\b/ },
            { type: 'function', regex: /\b[a-zA-Z_$]\w*(?=\()/ },
        ],
        python: [
