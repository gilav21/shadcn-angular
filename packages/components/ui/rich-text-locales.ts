...
export const RICH_TEXT_LOCALES: Record<string, RichTextLocale> = {
    ...
    he: {
        ...
        fontSize: {
            selectSize: 'בחר גודל',
            selectSizePlaceholder: 'בחר גודל',
        ...
        slashCommands: {
            ...
            paragraph: 'פסקה',
            paragraphDescription: 'עבור לטקסט פסקה',
            heading1: 'כותרת 1',
            ...
            bulletList: 'רשימת תבליטים',
            bulletListDescription: 'צור רשימה עם תבליטים',
            numberedList: 'רשימה ממוספרת',
            numberedListDescription: 'צור רשימה ממוספרת',
            blockQuote: 'ציטוט',
            blockQuoteDescription: 'הוסף בלוק ציטוט',
            inlineCode: 'קוד בתוך שורה',
            inlineCodeDescription: 'עטוף בחירה בקוד',
            codeBlock: 'בלוק קוד',
            codeBlockDescription: 'הוסף בלוק קוד',
            link: 'קישור',
            linkDescription: 'הוסף או ערוך קישור',
            undo: 'בטל',
            undoDescription: 'בטל שינוי אחרון',
            redo: 'בצע שוב',
            redoDescription: 'בצע שוב שינוי שבוטל',
        },
        history: {
            button: 'היסטוריה ({count})',
            title: 'היסטוריית גרסאות',
            browserDescription: 'השתמש בדפדפן זה כשכפתור ההיסטוריה מוסתר.',
            revision: 'גרסה {index}',
            applied: 'הוחל',
            preview: 'תצוגה מקדימה',
            renderedPreview: 'תצוגה מעובדת',
            markdownSnapshot: 'תמונת מצב Markdown',
            capturedAt: 'נלכד ב-{time}',
            cancel: 'ביטול',
            restore: 'שחזר גרסה זו',
            close: 'סגור',
            moreLines: '+{count} שורות נוספות',
            ariaOpen: 'פתח היסטוריית גרסאות (Ctrl או Command + Shift + H)',
            ariaClose: 'סגור היסטוריית גרסאות',
            ariaApply: 'החל גרסה {index}',
        },
        mentions: {
    ...
    ar: {
        ...
        fontSize: {
            ...
            selectSizePlaceholder: 'اختر حجمًا',
            customSize: 'حجم مخصص',
            apply: 'تطبيق',
        },
        color: {
        ...
        history: {
            button: 'السجل ({count})',
            title: 'سجل المراجعات',
            browserDescription: 'استخدم هذا المتصفح عندما يكون زر السجل مخفيًا.',
