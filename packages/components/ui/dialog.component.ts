    ...
    @if (dialog?.open()) {
      <div class="fixed inset-0 z-50 flex items-center justify-center">
        ...
        >
          ...
          <button
            type="button"
            class="absolute w-fit right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none rtl:left-4 rtl:right-auto"
            (click)="close()"
          >
