/**
 * T-6 — compile-time proof that `ui-toggle-group` satisfies the Signal Forms
...
describe('ToggleGroupComponent — FormValueControl conformance (T-6)', () => {
    it('is assignable to FormValueControl and exposes `value` as a model', () => {
        const fixture = TestBed.createComponent(ToggleGroupComponent);
        const control: FormValueControl<string | string[] | undefined> = fixture.componentInstance;
