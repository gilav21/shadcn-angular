...
export const baseColors: Record<BaseColor, ColorBlock> = {
  ...
  slate: {
    light: {
      ...
      '--accent': 'oklch(0.922 0.007 247.896)',
  ...
  stone: {
    light: {
      ...
      '--accent': 'oklch(0.922 0.001 106.424)',
  ...
  gray: {
    light: {
      ...
      '--accent': 'oklch(0.922 0.003 264.542)',
  ...
  zinc: {
    light: {
      ...
      '--accent': 'oklch(0.922 0.001 286.375)',
