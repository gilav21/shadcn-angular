...
export const registry = defineRegistry({
  ...
  'code-block': {
    ...
    libFiles: ['code-scopes.ts', 'i18n/i18n.token.ts', 'i18n/i18n.types.ts', 'i18n/i18n.utils.ts', 'i18n/index.ts'],
    dependencies: ['button'],
  ...
  'rich-text-editor': {
    ...
    libFiles: ['addon-slots.ts', 'i18n/i18n.token.ts', 'i18n/i18n.types.ts', 'i18n/i18n.utils.ts', 'i18n/index.ts', 'parsers/image-validator.ts', 'parsers/svg-sanitizer.ts', 'shortcut-binding.service.ts'],
    breaking: [
      ...
      { kind: 'removal', from: 'the [customToolbarItems] input + (customToolbarAction) output on <ui-rich-text-editor> (RichTextCustomToolbarItem / RichTextEditorRef types)', to: 'a toolbar slot registered through RichTextEditorAddonHost.toolbarSlots', note: 'Custom toolbar buttons are now addons: inject(RichTextEditorAddonHost).toolbarSlots.register({ id, icon, tooltip, onClick }) from a directive on the editor element. This is the only extension path now — the removed one recorded no undo entry for its inserts. Map the ref methods onto the public editor API: ref.insertText -> editor.insertText(), ref.insertHtml -> editor.insertHtml(), ref.getSelectedText -> editor.selection().text, ref.getHtmlContent -> editor.htmlOutput(), ref.focus -> editor.focus(). See docs/rich-text-editor.md for a worked ~40-line example.', codemod: 'none' },
    ],
    shortcutDefinitions: [
      {
  ...
  'rich-text-view': {
    ...
    files: ['rich-text-view/index.ts', 'rich-text-view/rich-text-view.component.html', 'rich-text-view/rich-text-view.component.ts'],
  ...
  'rich-text-editor/actions': {
    ...
    libFiles: ['addon-slots.ts', 'i18n/i18n.token.ts', 'i18n/i18n.types.ts', 'i18n/i18n.utils.ts', 'i18n/index.ts', 'parsers/image-validator.ts', 'parsers/svg-sanitizer.ts'],
