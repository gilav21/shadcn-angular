...
export const registry = defineRegistry({
  ...
  histogram: {
    ...
    files: ['histogram/index.ts', 'histogram/histogram.component.html', 'histogram/histogram.component.ts', 'histogram/histogram.types.ts', 'histogram/histogram.utils.ts'],
    libFiles: ['chart-responsive.ts', 'chart-scale.ts', 'chart.types.ts', 'chart.utils.ts'],
    dependencies: ['chart-tooltip'],
  },
  boxplot: {
    ...
    files: ['boxplot/index.ts', 'boxplot/boxplot.component.html', 'boxplot/boxplot.component.ts', 'boxplot/boxplot.types.ts', 'boxplot/boxplot.utils.ts'],
    libFiles: ['chart-responsive.ts', 'chart-scale.ts', 'chart.types.ts', 'chart.utils.ts'],
    dependencies: ['chart-tooltip'],
  },
  candlestick: {
    ...
    files: ['candlestick/index.ts', 'candlestick/candlestick.component.html', 'candlestick/candlestick.component.ts', 'candlestick/candlestick.types.ts', 'candlestick/candlestick.utils.ts'],
    libFiles: ['chart-responsive.ts', 'chart-scale.ts', 'chart.types.ts', 'chart.utils.ts'],
    dependencies: ['chart-tooltip'],
  },
  treemap: {
