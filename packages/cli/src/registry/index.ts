...
export const registry = defineRegistry({
  ...
  autocomplete: {
    ...
    libFiles: ['i18n/common.locales.ts', 'i18n/i18n.token.ts', 'i18n/i18n.types.ts', 'i18n/i18n.utils.ts', 'i18n/index.ts', 'top-layer.ts'],
  ...
  button: {
    ...
    libFiles: ['i18n/common.locales.ts', 'i18n/i18n.token.ts', 'i18n/i18n.types.ts', 'i18n/i18n.utils.ts', 'i18n/index.ts', 'theme-presets.ts'],
  ...
  calendar: {
    ...
    libFiles: ['i18n/calendar.locales.ts', 'i18n/i18n.token.ts', 'i18n/i18n.types.ts', 'i18n/i18n.utils.ts', 'i18n/index.ts'],
  ...
  'color-picker': {
    name: 'color-picker',
    category: 'form',
    description: 'Interactive picker for choosing colors via swatches, sliders, and hex/rgb inputs.',
    ...
    libFiles: ['color-extract.ts', 'color.ts', 'i18n/i18n.token.ts', 'i18n/i18n.types.ts', 'i18n/i18n.utils.ts', 'i18n/index.ts', 'touch.ts'],
  },
  confetti: {
    name: 'confetti',
    category: 'animation',
  ...
  'context-menu': {
    name: 'context-menu',
    category: 'navigation',
    description: 'Right-click (or long-press) menu with items, submenus, and keyboard shortcuts.',
    ...
    libFiles: ['theme-presets.ts', 'touch.ts'],
  ...
  chat: {
    name: 'chat',
    category: 'editor',
    description: 'Chat interface with scrollable message list, avatars, and a composer input.',
  ...
  sparkles: {
    name: 'sparkles',
    category: 'animation',
    description: 'Adds animated sparkle particles around content or a button for emphasis.',
  ...
  'code-block': {
    name: 'code-block',
    category: 'editor',
    description: 'Syntax-highlighted code display with a copy-to-clipboard button.',
    tags: ['code-block', 'code', 'syntax', 'highlight', 'snippet'],
    ...
    libFiles: ['code-highlight.ts', 'code-scopes.ts', 'i18n/i18n.token.ts', 'i18n/i18n.types.ts', 'i18n/i18n.utils.ts', 'i18n/index.ts'],
    dependencies: ['button'],
  ...
  'currency-input': {
    name: 'currency-input',
    category: 'form',
    description: 'Money input that formats and parses for any locale and currency, including non-ASCII digits.',
    tags: ['currency-input', 'money', 'amount', 'price', 'intl'],
    files: ['currency-input/currency-input.component.css', 'currency-input/currency-input.component.html', 'currency-input/currency-input.component.ts', 'currency-input/currency-input.format.ts', 'currency-input/index.ts'],
    libFiles: ['i18n/i18n.token.ts', 'i18n/i18n.types.ts', 'i18n/i18n.utils.ts', 'i18n/index.ts', 'input-group.token.ts'],
    dependencies: ['input'],
    testFiles: ['currency-input/currency-input.component.spec.ts', 'currency-input/currency-input.format.spec.ts'],
  },
  'data-table': {
    name: 'data-table',
    category: 'data-display',
    ...
    libFiles: ['addon-slots.ts', 'ai.ts', 'component-pool.service.ts', 'i18n/calendar.locales.ts', 'i18n/i18n.token.ts', 'i18n/i18n.types.ts', 'i18n/i18n.utils.ts', 'i18n/index.ts', 'theme-presets.ts', 'touch.ts'],
  ...
  'data-table/context-menu': {
    ...
    testFiles: ['data-table/addons/context-menu/context-menu.directive.spec.ts'],
  ...
  'data-table/export': {
    ...
    libFiles: ['i18n/i18n.token.ts', 'i18n/i18n.types.ts', 'i18n/i18n.utils.ts', 'i18n/index.ts', 'parsers/xlsx.ts'],
    dependencies: ['data-table'],
    testFiles: ['data-table/addons/export/export.directive.spec.ts'],
    requiresBaseFiles: ['data-table/data-table.host.ts'],
    category: 'data-display',
  ...
  'data-table/pivot': {
    ...
    type: 'addon',
    parent: 'data-table',
    files: ['data-table/addons/pivot/index.ts', 'data-table/addons/pivot/pivot.directive.ts', 'data-table/addons/pivot/pivot.utils.ts'],
    dependencies: ['data-table'],
    testFiles: ['data-table/addons/pivot/pivot.directive.spec.ts'],
    requiresBaseFiles: ['data-table/data-table.host.ts'],
    category: 'data-display',
  ...
  'tree-select': {
    name: 'tree-select',
    category: 'form',
    description: 'Dropdown select backed by a hierarchical tree for picking nested options.',
    tags: ['tree-select', 'tree', 'select', 'dropdown', 'hierarchy'],
  ...
  'input-mask': {
    name: 'input-mask',
    category: 'form',
    description: 'Directive that formats input text against a pattern (phone, date, card numbers).',
    tags: ['input-mask', 'mask', 'format', 'pattern', 'input'],
  ...
  'file-viewer': {
    name: 'file-viewer',
    category: 'media',
    description: 'In-browser viewer rendering PDF, DOCX, XLSX, images, and other documents.',
  ...
  'phone-input': {
    name: 'phone-input',
    category: 'form',
    description: 'International phone number input with country selector and format masking.',
    tags: ['phone-input', 'phone', 'tel', 'country', 'mobile'],
  ...
  popover: {
    ...
    libFiles: ['a11y.ts', 'overlay-stack.service.ts', 'theme-presets.ts'],
  ...
  progress: {
    name: 'progress',
    category: 'feedback',
    description: 'Horizontal progress bar that visualizes completion from 0 to 100 percent.',
  ...
  rating: {
    name: 'rating',
    category: 'form',
    description: 'Star rating input for capturing or displaying a score with half-step support.',
  ...
  'scroll-area': {
    name: 'scroll-area',
    category: 'layout',
    description: 'Scrollable container with custom, cross-browser styled scrollbars.',
  ...
  sidebar: {
    name: 'sidebar',
    category: 'navigation',
    description: 'Collapsible app sidebar with grouped menu items, header, and footer.',
    tags: ['sidebar', 'navigation', 'drawer', 'side-nav', 'menu'],
    files: ['sidebar/index.ts', 'sidebar/sidebar.component.ts', 'sidebar/sidebar.service.ts', 'sidebar/sub/sidebar-content.component.ts', 'sidebar/sub/sidebar-footer.component.ts', 'sidebar/sub/sidebar-group-content.component.ts', 'sidebar/sub/sidebar-group-label.component.ts', 'sidebar/sub/sidebar-group.component.ts', 'sidebar/sub/sidebar-header.component.ts', 'sidebar/sub/sidebar-inset.component.ts', 'sidebar/sub/sidebar-menu-action.component.css', 'sidebar/sub/sidebar-menu-action.component.ts', 'sidebar/sub/sidebar-menu-badge.component.ts', 'sidebar/sub/sidebar-menu-button.component.ts', 'sidebar/sub/sidebar-menu-item.component.ts', 'sidebar/sub/sidebar-menu-link.component.ts', 'sidebar/sub/sidebar-menu-skeleton.component.ts', 'sidebar/sub/sidebar-menu-sub-button.component.ts', 'sidebar/sub/sidebar-menu-sub-item.component.ts', 'sidebar/sub/sidebar-menu-sub-trigger.component.ts', 'sidebar/sub/sidebar-menu-sub.component.ts', 'sidebar/sub/sidebar-menu.component.ts', 'sidebar/sub/sidebar-provider.component.ts', 'sidebar/sub/sidebar-rail.component.ts', 'sidebar/sub/sidebar-separator.component.ts', 'sidebar/sub/sidebar-trigger.component.ts'],
    dependencies: ['scroll-area', 'skeleton', 'tooltip'],
  ...
  toast: {
    name: 'toast',
    category: 'feedback',
    description: 'Transient notification messages that stack and auto-dismiss from a corner.',
  ...
  tooltip: {
    name: 'tooltip',
    category: 'overlay',
    description: 'Small floating label that explains an element on hover or focus.',
  ...
  'rich-text-view': {
    ...
    libFiles: ['code-highlight.ts', 'i18n/i18n.token.ts', 'i18n/i18n.types.ts', 'i18n/i18n.utils.ts', 'i18n/index.ts'],
  ...
  'pie-chart': {
    name: 'pie-chart',
    category: 'charts',
    description: 'Pie/donut chart for showing parts of a whole as proportional slices.',
  ...
  'pie-chart-drilldown': {
    ...
    category: 'charts',
    description: 'Interactive pie chart whose slices drill down into nested sub-charts.',
  ...
  'component-outlet': {
    ...
    libFiles: ['component-pool.service.ts'],
  },
  'split-button': {
    name: 'split-button',
    category: 'navigation',
    description: 'Primary action button paired with a dropdown of secondary actions.',
  ...
  'shortcut-bindings-dialog': {
    ...
    category: 'overlay',
    description: 'Dialog listing keyboard shortcuts grouped by category for reference.',
    tags: ['shortcut-bindings-dialog', 'shortcuts', 'keyboard', 'hotkeys', 'dialog'],
    ...
    libFiles: ['i18n/i18n.token.ts', 'i18n/i18n.types.ts', 'i18n/i18n.utils.ts', 'i18n/index.ts', 'shortcut-binding.service.ts'],
  ...
  sortable: {
    ...
    testFiles: ['sortable/sortable.component.spec.ts', 'sortable/sortable.nested.spec.ts', 'sortable/sub/sortable-ghost.directive.spec.ts'],
  },
  'context-menu-attach': {
    name: 'context-menu-attach',
    category: 'utility',
    description: 'Directive that attaches a context menu to any element via right-click or long-press.',
  ...
  'tree-context-menu': {
    ...
    category: 'utility',
    description: 'Directive wiring a context menu to tree nodes for per-node right-click actions.',
  ...
  'table-context-menu': {
    ...
    category: 'utility',
    description: 'Directive wiring a context menu to table rows and headers for right-click actions.',
  ...
  'data-table-context-menu': {
    name: 'data-table-context-menu',
    category: 'utility',
    description: 'Directive adding right-click context menus to data-table rows and columns.',
  ...
  eyedropper: {
    name: 'eyedropper',
    category: 'form',
    description: 'Tool for sampling a color from anywhere on screen via the EyeDropper API.',
    tags: ['eyedropper', 'color', 'picker', 'sample', 'pipette'],
    ...
    libFiles: ['color.ts', 'i18n/i18n.token.ts', 'i18n/i18n.types.ts', 'i18n/i18n.utils.ts', 'i18n/index.ts', 'touch.ts'],
    dependencies: ['icon'],
  ...
  login: {
    ...
    dependencies: ['button', 'card', 'checkbox', 'input', 'label'],
    category: 'auth',
  ...
  'settings-profile': {
    ...
    dependencies: ['avatar', 'button', 'card', 'input', 'label', 'separator', 'textarea'],
    category: 'settings',
  ...
  pricing: {
    ...
    dependencies: ['badge', 'button', 'card', 'icon', 'separator'],
    category: 'marketing',
  ...
  signup: {
    name: 'signup',
    type: 'block',
    files: ['signup/index.ts', 'signup/signup.component.html', 'signup/signup.component.ts'],
    dependencies: ['button', 'card', 'checkbox', 'input', 'label'],
    category: 'auth',
    description: 'Account registration page with name, email, password, a terms checkbox, and Google sign-up.',
    tags: ['signup', 'auth', 'register', 'form'],
  },
  'forgot-password': {
    ...
    tags: ['forgot-password', 'auth', 'reset', 'form'],
  },
  'settings-account': {
  ...
  'data-table-range-chart': {
    ...
    category: 'charts',
    description: 'Dialog that visualizes a data table\'s selected range as a bar, pie, or stacked bar chart.',
    tags: ['data-table-range-chart', 'chart', 'range', 'dialog', 'visualization'],
  ...
  'chart-legend': {
    name: 'chart-legend',
    category: 'charts',
    description: 'Interactive chart legend with series show/hide toggling.',
  ...
  'chart-brush': {
    name: 'chart-brush',
    category: 'charts',
    description: 'Zoom, pan, and brush selection overlay for dense cartesian charts.',
  ...
  'rich-text-editor/actions': {
    ...
    libFiles: ['addon-slots.ts', 'i18n/i18n.token.ts', 'i18n/i18n.types.ts', 'i18n/i18n.utils.ts', 'i18n/index.ts', 'parsers/image-validator.ts', 'parsers/svg-sanitizer.ts', 'theme-presets.ts'],
  ...
  'rich-text-editor/emoji': {
    ...
    testFiles: ['rich-text-editor/addons/emoji/rich-text-emoji-button.component.spec.ts', 'rich-text-editor/addons/emoji/rich-text-emoji.directive.spec.ts'],
  ...
  'rich-text-editor/colors': {
    name: 'rich-text-editor/colors',
    type: 'addon',
    parent: 'rich-text-editor',
    category: 'editor',
    description: 'Text-colour and highlight-colour toolbar buttons for the rich text editor; applies inline colour styles to the selection.',
    tags: ['rich-text', 'color', 'highlight', 'toolbar', 'addon'],
    ...
    libFiles: ['addon-slots.ts', 'color.ts', 'i18n/i18n.token.ts', 'i18n/i18n.types.ts', 'i18n/i18n.utils.ts', 'i18n/index.ts'],
    dependencies: ['color-picker', 'popover', 'rich-text-editor'],
    testFiles: ['rich-text-editor/addons/colors/rich-text-colors-button.component.spec.ts', 'rich-text-editor/addons/colors/rich-text-colors.directive.spec.ts'],
    requiresBaseFiles: ['rich-text-editor/rich-text-editor.host.ts'],
    breaking: [
  ...
  'rich-text-editor/typography': {
    ...
    testFiles: ['rich-text-editor/addons/typography/rich-text-typography.directive.spec.ts'],
    requiresBaseFiles: ['rich-text-editor/rich-text-editor.host.ts'],
    breaking: [
  ...
  'rich-text-editor/links': {
    ...
    libFiles: ['addon-slots.ts', 'i18n/i18n.token.ts', 'i18n/i18n.types.ts', 'i18n/i18n.utils.ts', 'i18n/index.ts', 'theme-presets.ts'],
    dependencies: ['button', 'popover', 'rich-text-editor'],
    testFiles: ['rich-text-editor/addons/links/rich-text-links-button.component.spec.ts', 'rich-text-editor/addons/links/rich-text-links-form.component.spec.ts', 'rich-text-editor/addons/links/rich-text-links.directive.spec.ts'],
  ...
  'rich-text-editor/tables': {
    name: 'rich-text-editor/tables',
    type: 'addon',
    parent: 'rich-text-editor',
    category: 'editor',
    description: 'Table insert for the rich text editor: a toolbar button and 8x8 grid picker that inserts an empty table at the caret.',
    tags: ['rich-text', 'table', 'grid', 'toolbar', 'addon'],
    files: ['rich-text-editor/addons/tables/index.ts', 'rich-text-editor/addons/tables/rich-text-tables-button.component.html', 'rich-text-editor/addons/tables/rich-text-tables-button.component.ts', 'rich-text-editor/addons/tables/rich-text-tables.context.ts', 'rich-text-editor/addons/tables/rich-text-tables.directive.ts', 'rich-text-editor/addons/tables/rich-text-tables.locales.ts'],
    libFiles: ['addon-slots.ts', 'i18n/i18n.token.ts', 'i18n/i18n.types.ts', 'i18n/i18n.utils.ts', 'i18n/index.ts'],
    dependencies: ['popover', 'rich-text-editor'],
    testFiles: ['rich-text-editor/addons/tables/rich-text-tables-button.component.spec.ts', 'rich-text-editor/addons/tables/rich-text-tables.directive.spec.ts'],
    requiresBaseFiles: ['rich-text-editor/rich-text-editor.host.ts'],
    breaking: [
  ...
  'rich-text-editor/images': {
    ...
    parent: 'rich-text-editor',
    category: 'editor',
    description: 'Image support for the rich text editor: toolbar insert popover, paste/drag-drop, upload + auto-upload pipeline, and a resize/align overlay.',
    tags: ['rich-text', 'image', 'upload', 'resize', 'toolbar', 'addon'],
    ...
    libFiles: ['addon-slots.ts', 'i18n/i18n.token.ts', 'i18n/i18n.types.ts', 'i18n/i18n.utils.ts', 'i18n/index.ts', 'parsers/image-validator.ts'],
    dependencies: ['button', 'popover', 'rich-text-editor'],
  ...
  'rich-text-editor/mentions': {
    name: 'rich-text-editor/mentions',
    type: 'addon',
    parent: 'rich-text-editor',
    category: 'editor',
    ...
    attach: {
      ...
      selector: 'uiRteMentions',
    },
  },
  'rich-text-editor/file-import': {
    name: 'rich-text-editor/file-import',
    type: 'addon',
    parent: 'rich-text-editor',
    category: 'editor',
  ...
  'rich-text-editor/ai': {
    ...
    testFiles: ['rich-text-editor/addons/ai/rich-text-ai-chip.component.spec.ts', 'rich-text-editor/addons/ai/rich-text-ai-panel.component.spec.ts', 'rich-text-editor/addons/ai/rich-text-ai.directive.spec.ts'],
    requiresBaseFiles: ['rich-text-editor/rich-text-editor.host.ts', 'rich-text-editor/rich-text-sanitizer.service.ts'],
    attach: {
  ...
  'rich-text-editor/outline': {
    name: 'rich-text-editor/outline',
    type: 'addon',
    parent: 'rich-text-editor',
    category: 'editor',
    description: 'Document outline for the rich text editor: a toolbar button + /outline command that open a docked, live table-of-contents panel.',
    tags: ['rich-text', 'outline', 'toc', 'navigation', 'addon'],
    files: ['rich-text-editor/addons/outline/index.ts', 'rich-text-editor/addons/outline/rich-text-outline-panel.component.html', 'rich-text-editor/addons/outline/rich-text-outline-panel.component.ts', 'rich-text-editor/addons/outline/rich-text-outline.context.ts', 'rich-text-editor/addons/outline/rich-text-outline.directive.ts', 'rich-text-editor/addons/outline/rich-text-outline.locales.ts'],
    libFiles: ['addon-slots.ts', 'i18n/i18n.token.ts', 'i18n/i18n.types.ts', 'i18n/i18n.utils.ts', 'i18n/index.ts'],
    dependencies: ['button', 'rich-text-editor', 'scroll-area'],
    testFiles: ['rich-text-editor/addons/outline/rich-text-outline-panel.component.spec.ts', 'rich-text-editor/addons/outline/rich-text-outline.directive.spec.ts'],
    requiresBaseFiles: ['rich-text-editor/rich-text-editor.host.ts'],
    breaking: [
  ...
  'infinite-canvas/node-editor-subgraph': {
    ...
    files: ['infinite-canvas/addons/node-editor-subgraph/index.ts', 'infinite-canvas/addons/node-editor-subgraph/node-editor-subgraph-breadcrumb.component.html', 'infinite-canvas/addons/node-editor-subgraph/node-editor-subgraph-breadcrumb.component.ts', 'infinite-canvas/addons/node-editor-subgraph/node-editor-subgraph.locales.ts', 'infinite-canvas/addons/node-editor-subgraph/node-editor-subgraph.navigator.ts', 'infinite-canvas/addons/node-editor-subgraph/node-editor-subgraph.ts', 'infinite-canvas/addons/node-editor-subgraph/node-editor-subgraph.types.ts'],
    libFiles: ['i18n/i18n.token.ts', 'i18n/i18n.types.ts', 'i18n/i18n.utils.ts', 'i18n/index.ts'],
    dependencies: ['infinite-canvas/node-editor'],
    attach: {
      import: "subgraphNodeType from './ui/infinite-canvas/addons/node-editor-subgraph'",
      selector: 'subgraphNodeType',
    },
  },
  'infinite-canvas/node-editor-context-menu': {
    name: 'infinite-canvas/node-editor-context-menu',
    type: 'addon',
    parent: 'infinite-canvas',
    category: 'layout',
    ...
    files: ['infinite-canvas/addons/node-editor-context-menu/index.ts', 'infinite-canvas/addons/node-editor-context-menu/node-editor-context-menu.directive.ts', 'infinite-canvas/addons/node-editor-context-menu/node-editor-context-menu.resolve.ts', 'infinite-canvas/addons/node-editor-context-menu/node-editor-context-menu.types.ts'],
    libFiles: ['touch.ts'],
    dependencies: ['context-menu', 'infinite-canvas/node-editor'],
    attach: {
      import: "NodeEditorContextMenuDirective from './ui/infinite-canvas/addons/node-editor-context-menu'",
      selector: 'uiNodeEditorContextMenu',
    },
  },
  'infinite-canvas/node-editor-groups': {
    name: 'infinite-canvas/node-editor-groups',
    type: 'addon',
    parent: 'infinite-canvas',
    category: 'layout',
    ...
    libFiles: ['i18n/i18n.token.ts', 'i18n/i18n.types.ts', 'i18n/i18n.utils.ts', 'i18n/index.ts', 'touch.ts'],
    dependencies: ['infinite-canvas', 'infinite-canvas/node-editor'],
    attach: {
      import: "NodeEditorGroupsComponent from './ui/infinite-canvas/addons/node-editor-groups'",
      selector: 'ui-node-editor-groups',
    },
  },
  'infinite-canvas/node-editor-history': {
    name: 'infinite-canvas/node-editor-history',
    type: 'addon',
    parent: 'infinite-canvas',
    category: 'layout',
    ...
    files: ['infinite-canvas/addons/node-editor-history/index.ts', 'infinite-canvas/addons/node-editor-history/node-editor-history.component.html', 'infinite-canvas/addons/node-editor-history/node-editor-history.component.ts', 'infinite-canvas/addons/node-editor-history/node-editor-history.locales.ts', 'infinite-canvas/addons/node-editor-history/node-editor-history.store.ts', 'infinite-canvas/addons/node-editor-history/node-editor-history.types.ts', 'infinite-canvas/addons/node-editor-history/node-editor-history.utils.ts'],
    libFiles: ['i18n/i18n.token.ts', 'i18n/i18n.types.ts', 'i18n/i18n.utils.ts', 'i18n/index.ts'],
    dependencies: ['infinite-canvas/node-editor'],
    attach: {
      import: "NodeEditorHistoryComponent from './ui/infinite-canvas/addons/node-editor-history'",
      selector: 'ui-node-editor-history',
    },
  },
  'infinite-canvas/node-editor-layout': {
    name: 'infinite-canvas/node-editor-layout',
    type: 'addon',
    parent: 'infinite-canvas',
    category: 'layout',
    ...
    files: ['infinite-canvas/addons/node-editor-layout/index.ts', 'infinite-canvas/addons/node-editor-layout/node-editor-layout.ts'],
    dependencies: ['infinite-canvas/node-editor'],
    attach: {
      import: "layoutGraph from './ui/infinite-canvas/addons/node-editor-layout'",
      selector: 'layoutGraph',
    },
  },
  'infinite-canvas/node-editor-minimap': {
    name: 'infinite-canvas/node-editor-minimap',
    type: 'addon',
    parent: 'infinite-canvas',
    category: 'layout',
    ...
    files: ['infinite-canvas/addons/node-editor-minimap/index.ts', 'infinite-canvas/addons/node-editor-minimap/node-editor-minimap.component.html', 'infinite-canvas/addons/node-editor-minimap/node-editor-minimap.component.ts', 'infinite-canvas/addons/node-editor-minimap/node-editor-minimap.locales.ts', 'infinite-canvas/addons/node-editor-minimap/node-editor-minimap.utils.ts'],
    libFiles: ['i18n/i18n.token.ts', 'i18n/i18n.types.ts', 'i18n/i18n.utils.ts', 'i18n/index.ts', 'touch.ts'],
    dependencies: ['infinite-canvas/node-editor'],
    attach: {
      import: "NodeEditorMinimapComponent from './ui/infinite-canvas/addons/node-editor-minimap'",
      selector: 'ui-node-editor-minimap',
    },
  },
  'infinite-canvas/node-editor-palette': {
    name: 'infinite-canvas/node-editor-palette',
    type: 'addon',
    parent: 'infinite-canvas',
    category: 'layout',
    ...
    files: ['infinite-canvas/addons/node-editor-palette/index.ts', 'infinite-canvas/addons/node-editor-palette/node-editor-palette.component.html', 'infinite-canvas/addons/node-editor-palette/node-editor-palette.component.ts', 'infinite-canvas/addons/node-editor-palette/node-editor-palette.locales.ts', 'infinite-canvas/addons/node-editor-palette/node-editor-palette.utils.ts'],
    libFiles: ['i18n/common.locales.ts', 'i18n/i18n.token.ts', 'i18n/i18n.types.ts', 'i18n/i18n.utils.ts', 'i18n/index.ts', 'shortcut-binding.service.ts'],
    dependencies: ['command', 'infinite-canvas/node-editor'],
    attach: {
      import: "NodeEditorPaletteComponent from './ui/infinite-canvas/addons/node-editor-palette'",
      selector: 'ui-node-editor-palette',
    },
  },
  'infinite-canvas/node-editor-problems': {
    name: 'infinite-canvas/node-editor-problems',
    type: 'addon',
    parent: 'infinite-canvas',
    category: 'layout',
    ...
    files: ['infinite-canvas/addons/node-editor-problems/index.ts', 'infinite-canvas/addons/node-editor-problems/node-editor-problems.component.html', 'infinite-canvas/addons/node-editor-problems/node-editor-problems.component.ts', 'infinite-canvas/addons/node-editor-problems/node-editor-problems.locales.ts'],
    libFiles: ['i18n/i18n.token.ts', 'i18n/i18n.types.ts', 'i18n/i18n.utils.ts', 'i18n/index.ts'],
    dependencies: ['infinite-canvas/node-editor'],
    attach: {
  ...
  'infinite-canvas/node-editor': {
    name: 'infinite-canvas/node-editor',
    type: 'addon',
    parent: 'infinite-canvas',
    category: 'layout',
    ...
    addons: ['infinite-canvas/node-editor-stdlib', 'infinite-canvas/node-editor-text-output', 'infinite-canvas/node-editor-context-menu', 'infinite-canvas/node-editor-groups', 'infinite-canvas/node-editor-subgraph', 'infinite-canvas/node-editor-history', 'infinite-canvas/node-editor-layout', 'infinite-canvas/node-editor-minimap', 'infinite-canvas/node-editor-palette', 'infinite-canvas/node-editor-problems'],
  },
  'time-picker': {
    name: 'time-picker',
    category: 'form',
    description:
        'Time-of-day field whose segment order, meridiem and digits all come from the locale. Stores 24-hour "HH:mm", never a Date.',
    tags: ['time-picker', 'time', 'clock', 'hour', 'intl'],
    files: ['time-picker/index.ts', 'time-picker/time-picker.component.css', 'time-picker/time-picker.component.html', 'time-picker/time-picker.component.ts', 'time-picker/time-picker.format.ts'],
    libFiles: ['i18n/i18n.token.ts', 'i18n/i18n.types.ts', 'i18n/i18n.utils.ts', 'i18n/index.ts'],
    testFiles: ['time-picker/time-picker.component.spec.ts', 'time-picker/time-picker.format.spec.ts'],
  },
  'signature-pad': {
    name: 'signature-pad',
    category: 'form',
    description:
        'Hand-drawn signature on a canvas. Strokes are the source of truth; the value is a PNG data URL. Touch-first, undo and clear.',
    tags: ['signature-pad', 'signature', 'canvas', 'draw', 'consent'],
    files: ['signature-pad/index.ts', 'signature-pad/signature-pad.component.css', 'signature-pad/signature-pad.component.html', 'signature-pad/signature-pad.component.ts', 'signature-pad/signature-pad.strokes.ts'],
    libFiles: ['touch.ts'],
    dependencies: ['button'],
    testFiles: ['signature-pad/signature-pad.component.spec.ts', 'signature-pad/signature-pad.strokes.spec.ts'],
  },
  'infinite-canvas/node-editor-stdlib': {
    name: 'infinite-canvas/node-editor-stdlib',
    type: 'addon',
    parent: 'infinite-canvas',
    category: 'layout',
    description: 'Pure node types for the editor: text, number, logic, object, list and convert - the pieces users compose transformers from.',
    tags: ['node-editor', 'stdlib', 'nodes', 'transform', 'graph', 'toolbox'],
    files: ['infinite-canvas/addons/node-editor-stdlib/index.ts', 'infinite-canvas/addons/node-editor-stdlib/node-editor-stdlib.coerce.ts', 'infinite-canvas/addons/node-editor-stdlib/node-editor-stdlib.convert.ts', 'infinite-canvas/addons/node-editor-stdlib/node-editor-stdlib.list.ts', 'infinite-canvas/addons/node-editor-stdlib/node-editor-stdlib.logic.ts', 'infinite-canvas/addons/node-editor-stdlib/node-editor-stdlib.number.ts', 'infinite-canvas/addons/node-editor-stdlib/node-editor-stdlib.object.ts', 'infinite-canvas/addons/node-editor-stdlib/node-editor-stdlib.text.ts'],
    dependencies: ['infinite-canvas/node-editor'],
    attach: {
      import: "STDLIB_NODE_TYPES from './ui/infinite-canvas/addons/node-editor-stdlib'",
      selector: 'STDLIB_NODE_TYPES',
    },
  },
  'infinite-canvas/node-editor-text-output': {
    name: 'infinite-canvas/node-editor-text-output',
    type: 'addon',
    parent: 'infinite-canvas',
    category: 'layout',
    description: 'A display node that takes text and how to draw it, so a graph can style its own output without a node per style.',
    tags: ['node-editor', 'output', 'display', 'text', 'style', 'graph'],
    files: ['infinite-canvas/addons/node-editor-text-output/index.ts', 'infinite-canvas/addons/node-editor-text-output/node-editor-text-output.component.html', 'infinite-canvas/addons/node-editor-text-output/node-editor-text-output.component.ts', 'infinite-canvas/addons/node-editor-text-output/node-editor-text-output.types.ts'],
    dependencies: ['infinite-canvas/node-editor'],
    attach: {
      import: "TEXT_OUTPUT_NODE from './ui/infinite-canvas/addons/node-editor-text-output'",
      selector: 'TEXT_OUTPUT_NODE',
    },
  },
});
