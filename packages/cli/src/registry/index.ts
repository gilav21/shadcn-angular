...
export const registry = defineRegistry({
  ...
  'data-table': {
    ...
    testFiles: ['data-table/data-table-advanced-filter.spec.ts', 'data-table/data-table-ai.spec.ts', 'data-table/data-table-autofit.spec.ts', 'data-table/data-table-column-builder.spec.ts', 'data-table/data-table-fill.spec.ts', 'data-table/data-table-grid-semantics.spec.ts', 'data-table/data-table-paste.spec.ts', 'data-table/data-table-query.spec.ts', 'data-table/data-table-virtual-scroll.spec.ts', 'data-table/data-table.component.spec.ts', 'data-table/data-table.coverage.spec.ts', 'data-table/data-table.host.spec.ts', 'data-table/sub/data-table-column-header.component.spec.ts', 'data-table/sub/data-table-date-filter.component.spec.ts', 'data-table/sub/data-table-multiselect-filter.component.spec.ts', 'data-table/sub/data-table-pagination.component.spec.ts'],
