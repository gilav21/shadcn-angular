...
export const registry = defineRegistry({
  ...
  'infinite-canvas/node-editor': {
    ...
    addons: ['infinite-canvas/node-editor-context-menu', 'infinite-canvas/node-editor-groups', 'infinite-canvas/node-editor-subgraph', 'infinite-canvas/node-editor-history', 'infinite-canvas/node-editor-layout', 'infinite-canvas/node-editor-minimap', 'infinite-canvas/node-editor-palette', 'infinite-canvas/node-editor-problems'],
  },
  'time-picker': {
    name: 'time-picker',
    category: 'form',
