          ...
          <div class="grid gap-4">
            ...
            <div class="grid gap-2">
              <div class="grid grid-cols-3 items-center gap-4">
                <ui-label htmlFor="width">Width</ui-label>
                <ui-input id="width" value="100%" class="col-span-2 h-8" />
              </div>
              <div class="grid grid-cols-3 items-center gap-4">
                <ui-label htmlFor="maxWidth">Max. width</ui-label>
                <ui-input id="maxWidth" value="300px" class="col-span-2 h-8" />
              </div>
              <div class="grid grid-cols-3 items-center gap-4">
                <ui-label htmlFor="height">Height</ui-label>
                <ui-input id="height" value="25px" class="col-span-2 h-8" />
              </div>
              <div class="grid grid-cols-3 items-center gap-4">
                <ui-label htmlFor="maxHeight">Max. height</ui-label>
