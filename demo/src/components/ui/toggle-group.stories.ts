...
export const Default: Story = {
    render: (args) => ({
      ...
      <ui-toggle-group [type]="type" [variant]="variant" [size]="size" [disabled]="disabled" defaultValue="left">
        <ui-toggle-group-item value="left" aria-label="Toggle bold">
        ...
        <ui-toggle-group-item value="center" aria-label="Toggle italic">
        ...
        <ui-toggle-group-item value="right" aria-label="Toggle underline">
