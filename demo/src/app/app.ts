...
export class AppComponent {
  ...
  hebrewKanbanColumns = signal<KanbanColumn[]>([
  ...
  hebrewKanbanCards = signal<KanbanCard[]>([
  ...
  hebrewKanbanHistory = signal<KanbanHistoryState>({ canUndo: false, canRedo: false });
  ...
  readonly virtualDemoColumns = computed(() =>
    generateVDemoColumns(100, this.virtualCellMode() === 'heavy', this.virtualVariableRows()) as ColumnDef<VDemoRow>[]
  );
