...
describe('DatePickerDemoComponent', () => {
  it('renders English title under default locale', () => {
    ...
    const fixture = TestBed.createComponent(DatePickerDemoComponent);
    fixture.detectChanges();
    expect(fixture.nativeElement.textContent).toContain(DATE_PICKER_DEMO_LOCALES['en'].title);
  });
  ...
  it('renders Hebrew title under provideUiLocale("he")', () => {
    ...
    const fixture = TestBed.createComponent(DatePickerDemoComponent);
    fixture.detectChanges();
    expect(fixture.nativeElement.textContent).toContain(DATE_PICKER_DEMO_LOCALES['he'].title);
  });
});
